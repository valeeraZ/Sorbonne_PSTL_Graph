...
def push2(adjacency: Union[sparse.csr_matrix, LinearOperator], seeds: np.ndarray, damping_factor: float,
                 tol: float = 1e-6) -> np.ndarray:
...
if __name__ == '__main__':
    ...
    time_start = time.time()
    scores = push2(adjacency, None, 0.85)
    time_end = time.time()
